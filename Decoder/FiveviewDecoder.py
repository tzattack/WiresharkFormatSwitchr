...
def decoder(file_dir_name, file_name):
    ...
    for i in full_content:
        ...
        included_length = full_content[pointer + 16:pointer + 20]
        print("included: " + str(included_length))

        timestamp_seconds = full_content[pointer + 24:pointer + 28]
        timestamp_microseconds = full_content[pointer + 28:pointer + 32]
        ...
        pointer = pointer + data_length + 36
